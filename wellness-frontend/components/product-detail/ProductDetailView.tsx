            ...
            <div className="flex gap-4 overflow-x-auto pb-2 scrollbar-hide">
              {images.map((img: string, idx: number) => (
                <button
                  ...
                  className={`relative w-24 aspect-square rounded-xl overflow-hidden border-2 transition-all shrink-0 bg-[#f5f5f5]
        ...
        >
          ...
          <p className="text-slate-600 text-lg leading-relaxed mb-8">
            {product.shortDescription ||
              product.description ||
              "Scientifically formulated to support your wellness journey with premium ingredients and advanced bioavailability."}
          </p>
              ...
              <div className="prose prose-slate max-w-none">
                ...
                <p className="text-slate-600 leading-relaxed whitespace-pre-line">
                  {product.longDescription ||
                    product.description ||
                    `Our ${product.name} is meticulously crafted to provide the highest quality nutraceutical support. Each batch undergoes rigorous testing to ensure purity and potency.`}
                </p>
                  ...
                  <div className="space-y-4">
                    {product.ingredients &&
                      (Array.isArray(product.ingredients)
                        ...
                        <div
                          key={idx}
                          className="flex items-center gap-3 p-3 rounded-lg bg-white border border-slate-100 shadow-sm"
                        >
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                  {product.benefits &&
                    (Array.isArray(product.benefits)
                      ...
                      <div
                        key={i}
                        className="p-6 rounded-2xl bg-white border border-slate-100 hover:shadow-md transition-shadow"
                      >
